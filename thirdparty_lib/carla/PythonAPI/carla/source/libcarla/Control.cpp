...
namespace rpc {
  ...
  std::ostream &operator<<(std::ostream &out, const VehicleControl &control) {
    out << "VehicleControl(throttle=" << std::to_string(control.throttle)
        ...
        << ", steering_mode=" << std::to_string(static_cast<unsigned>(control.steering_mode))
...
void export_control() {
  ...
  enum_<cr::VehicleSteeringMode>("VehicleSteeringMode")
    .value("Disable", cr::VehicleSteeringMode::Disable)
    .value("FrontAckerman", cr::VehicleSteeringMode::FrontAckerman)
    .value("DoubleAckerman", cr::VehicleSteeringMode::DoubleAckerman)
    .value("CrabSteer", cr::VehicleSteeringMode::CrabSteer)
    .value("FrontParallel", cr::VehicleSteeringMode::FrontParallel)
    .value("DoubleParallel", cr::VehicleSteeringMode::DoubleParallel)
    .value("GoToHome", cr::VehicleSteeringMode::GoToHome)
    .value("Calibration", cr::VehicleSteeringMode::Calibration)
  ;
  ...
  class_<cr::VehicleControl>("VehicleControl")
    .def(init<float, float, float, bool, bool, bool, int, float>(
      ...
      arg("gear") = 0,
      arg("timestamp") = 0.0f)))
    .def(init<float, float, float, bool, bool, bool, int, uint8_t>(
      (arg("throttle") = 0.0f,
      arg("steer") = 0.0f,
      arg("brake") = 0.0f,
      arg("hand_brake") = false,
      ...
      arg("manual_gear_shift") = false,
      arg("gear") = 0,
      arg("steering_mode") = static_cast<uint8_t>(cr::VehicleSteeringMode::FrontAckerman))))
    ...
    .def_readwrite("steering_mode", &cr::VehicleControl::steering_mode)
  ...
  class_<cr::VehicleAckermannControl>("VehicleAckermannControl")
    .def(init<float, float, float, float, float, float>(
      ...
      arg("jerk") = 0.0f,
      arg("timestamp") = 0.0f)))
    .def(init<float, float, float, float, float, uint8_t>(
      (arg("steer") = 0.0f,
      arg("steer_speed") = 0.0f,
      arg("speed") = 0.0f,
      arg("acceleration") = 0.0f,
    ...
    .def_readwrite("steering_mode", &cr::VehicleAckermannControl::steering_mode)
