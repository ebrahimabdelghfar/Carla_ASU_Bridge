...
void export_commands() {
  ...
  class_<cr::Command::ApplyVehicleSteeringMode>("ApplyVehicleSteeringMode")
    .def("__init__", &command_impl::CustomInit<ActorPtr, uint8_t>, (arg("actor"), arg("steering_mode")))
    .def(init<cr::ActorId, uint8_t>((arg("actor_id"), arg("steering_mode"))))
    .def_readwrite("actor_id", &cr::Command::ApplyVehicleSteeringMode::actor)
    .def_readwrite("steering_mode", &cr::Command::ApplyVehicleSteeringMode::steering_mode)
  ;
  ...
  implicitly_convertible<cr::Command::ApplyVehicleSteeringMode, cr::Command>();
