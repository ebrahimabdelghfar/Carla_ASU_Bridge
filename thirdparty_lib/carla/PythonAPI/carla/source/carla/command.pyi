...
class ApplyVehicleSteeringMode(_IsCommand):
    """Sparse steering-mode update (does not replace full vehicle control)."""
    ...
    def steering_mode(self) -> int:
        """Steering mode (see `VehicleSteeringMode`)."""
    # endregion

    # region Methods
    def __init__(self, actor: Actor | int, steering_mode: int | VehicleSteeringMode) -> None:
        """Applies only a steering mode change."""
