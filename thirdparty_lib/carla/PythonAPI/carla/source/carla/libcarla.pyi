...
class Vehicle(Actor):
    ...
    def apply_steering_mode(self, steering_mode: VehicleSteeringMode) -> None:
        """Sets only the steering mode (0–7) on the next tick without resending throttle/brake/gear. Does not deactivate Ackermann control."""
...
class VehicleAckermannControl:
    ...
    @property
    def steering_mode(self) -> int:
        """Steering mode (see `VehicleSteeringMode`). Default is front Ackermann (1)."""

    @steering_mode.setter
    def steering_mode(self, value: int) -> None: ...
    # endregion
...
class VehicleControl:
    ...
    @property
    def steering_mode(self) -> int:
        """Steering mode (see `VehicleSteeringMode`). Default matches front Ackermann."""
    @steering_mode.setter
    def steering_mode(self, value: int) -> None: ...
    # endregion
