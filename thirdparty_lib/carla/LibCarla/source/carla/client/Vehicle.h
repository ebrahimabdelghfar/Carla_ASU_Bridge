...
namespace client {
  ...
  public:
    ...
    /// Set steering mode only (sparse update); does not replace throttle/brake or exit Ackermann mode.
    void ApplySteeringMode(rpc::VehicleSteeringMode steering_mode);
